...
typedef struct
{
    ...
    #define FLASH_END_ADDR                 0x40000  //0x3FFFF
    ...
    /* EEPROM block end address: This is the final point address on EEPROM */
    #if(0 == FLASH_DERIVATIVE)      /* (G240) */
    #define EE_END_ADDR          0x1400 //0x013FF 
    #elif(1 == FLASH_DERIVATIVE)    /* (G192) */
    #define EE_END_ADDR          0x1400 //0x013FF 
    #elif(2 == FLASH_DERIVATIVE)    /* (G128) */
    #define EE_END_ADDR          0x1400 //0x013FF 
    #elif(3 == FLASH_DERIVATIVE)    /* (G96) */
    #define EE_END_ADDR          0x1000 //0x0FFF  
    #elif(4 == FLASH_DERIVATIVE)    /* (G64) */
    #define EE_END_ADDR          0xC00 //0x0BFF  
    #elif(5 == FLASH_DERIVATIVE)    /* (G48/GN48) */
    #define EE_END_ADDR          0xA00 //0x09FF 
    #elif(6 == FLASH_DERIVATIVE)    /* (GN32) */
    #define EE_END_ADDR          0x800 //0x07FF  
    #elif(7 == FLASH_DERIVATIVE)    /* (GN16) */
    #define EE_END_ADDR          0x600 //0x05FF 
    #elif(8 == FLASH_DERIVATIVE)
    #define EE_END_ADDR          0x600
    #elif(9 == FLASH_DERIVATIVE)
    #define EE_END_ADDR          0x600
    #endif
    ...
    #define USER_DEF_SECTOR_SIZE        0x0100  //must not smaller than 0x10,added by xyl 2014.10.23
    #define USER_DEF_SECTOR_NUM         3       //added by xyl 2014.10.23
    #define USER_DEF_ACTIVE_FLAG        0xFACF0000       //added by xyl 2014.10.23 
    #define USER_DEF_FREESPACE_FLAG        0xFFFFFFFF       //added by xyl 2014.10.23 
    #define NO_ACTIVE_USER_SECTOR 0xFF       //added by xyl 2014.10.23
    /* EEPROM maximum size */
